...
- **Open Links in Chrome** — When opening a link, local preview, or deployed page for the user, always open it in Google Chrome — never the OS default browser. Use `open -a "Google Chrome" <url>`.
